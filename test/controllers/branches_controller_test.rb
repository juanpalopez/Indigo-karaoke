...
class BranchesControllerTest < ActionController::TestCase
  ...
  test "should create branch" do
    assert_difference('Branch.count') do
      post :create, branch: { address: @branch.address, description: @branch.description, email: @branch.email, name: @branch.name, phone: @branch.phone }
    end
  ...
  test "should update branch" do
    patch :update, id: @branch, branch: { address: @branch.address, description: @branch.description, email: @branch.email, name: @branch.name, phone: @branch.phone }
    assert_redirected_to branch_path(assigns(:branch))
  end
